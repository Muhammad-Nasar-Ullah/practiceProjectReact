...
const Navbar = ({ mode, toggleMode }) => {
    ...
    return (
        <div className={`px-5 py-5 relative flex justify-between items-center sticky top-0 h-[70px] z-50 transition-all duration-500 ${mode === 'dark' ? 'bg-gray-800' : 'bg-gray-200'}`}>
            ...
            <div className={`flex flex-col gap-5 fixed top-0 w-full h-[100vh] z-[100] p-5 shadow-lg border transition-all duration-300 ease-in-out ${dropdown ? 'right-0' : '-right-full'} ${mode === 'dark' ? 'bg-gray-900 border-gray-700 text-white' : 'bg-white border-gray-200 text-gray-800'}`}>
