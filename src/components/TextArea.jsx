...
const TextArea = ({ mode }) => {
    ...
    return (
        <div className='flex flex-col gap-5 w-[40%] mx-auto my-5'>
            ...
            <p className={`${mode === 'dark' ? 'text-white' : 'text-black'}`}>{text.split(' ').length} words {text.length} characters</p>
            <p className={`${mode === 'dark' ? 'text-white' : 'text-black'}`}>{0.008 * text.split(' ').length} minutes to read</p>
